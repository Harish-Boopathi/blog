...
export const fetchPosts = createAsyncThunk('posts/fetchPosts',async() =>{
    const response = await axios({
        method: 'get',
        url: 'https://react-assignment-api.mallow-tech.com/api/public/posts',
        responseType: 'stream'
      })
    ...
    extraReducers(bulider){
        bulider
            ...
            .addCase(fetchPosts.fulfilled , (state , action) => {
                ...
                const loadedPosts = JSON.parse(action.payload)
...
export const { addPost , addReaction } = dashboardSlice.actions;